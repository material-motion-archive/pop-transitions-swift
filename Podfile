...
pod 'MaterialMotionTransitions', :git => 'https://github.com/material-motion/transitions-objc.git', :branch => 'develop'

target "Catalog" do
  pod 'CatalogByConvention'
  pod 'MaterialMotionPopTransitions/examples', :path => './'
  project 'examples/apps/Catalog/Catalog.xcodeproj'
end

target "UnitTests" do
  project 'examples/apps/Catalog/Catalog.xcodeproj'
  pod 'MaterialMotionPopTransitions/tests', :path => './'
end
